...
usage() {
  cat <<'EOF'
Usage: run_nccl_all_to_all.sh [options]
...
RAW_LOG="${OUT_RAW_DIR}/${RUN_ID}_${LABEL}_nccl_all_to_all.log"
STRUCT_OUT="${OUT_STRUCT_DIR}/${RUN_ID}_nccl_alltoall.json"
...
NCCL_BIN="${ROOT_DIR}/tools/nccl-tests/build/alltoall_perf"
