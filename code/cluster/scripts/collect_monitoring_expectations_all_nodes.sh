...
for idx in "${!HOST_ARR[@]}"; do
  ...
  out_json="${CLUSTER_STRUCTURED_DIR_EFFECTIVE}/${RUN_ID}_${label}_monitoring_expectations.json"
  out_log="${CLUSTER_RAW_DIR_EFFECTIVE}/${RUN_ID}_${label}_monitoring_expectations.log"
